...
<%
	  ...
	  nMgr.upCount(num);//조회수 증가
	  NoticeBean bean = nMgr.getnotice(num);//게시물 가져오기
...
<% String sessionID = (String)session.getAttribute("logID"); 
	...
	{
%>
              <a class="btn btn-default" href="/Jsp-Auction/index.jsp?PAGE=board/noticeUpdate">수정</a>
              <a class="btn btn-default" href="/Jsp-Auction/index.jsp?PAGE=board/noticeRemove">삭제</a>
<%} %>
            </div>
          </div>
